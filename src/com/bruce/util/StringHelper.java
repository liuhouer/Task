...
public class StringHelper {
   ...
   public static String defaultString(Object value) {
	 ...
	 * @return
	 */
	public static String getUnderscoreStr(String str) {
		return StringHelper.toUnderscoreName(str).toLowerCase();
	}
	 ...
	 * @return
	 */
	public static String getStrFirstLower(String str) {
	...
	public static String getConstantStr(String str) {
		return StringHelper.toUnderscoreName(str).toUpperCase();
	}
